...
1. Read the **Project Overview**: Follow the [Instructions for Understanding the Project](instructions/planning.instructions.md) and [README.md](COPILOT-README.md) to gather context about the project structure, existing code, and documentation.
...
1. Using **React Aria Components**: When building user interfaces using React Aria components for accessibility and consistency, refer to the React Aria MCP Server for documentation.
